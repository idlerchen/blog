...
<div class="sinabloga" id="sinabloga">
 ...
 <div id="sinablogHead" class="sinabloghead">
     <div style="display: none;" id="headflash" class="headflash"></div>
      ...
      <h1 id="blogname" class="blogtitle"><a href="/blog/page/personal/personalCenter.jsp">用户:${blog.username }的博客</a></h1>
		<div id="bloglink" class="bloglink"><a href="/blog/page/personal/personalCenter.jsp">http://blog.fenbi.com.cn/u/${blog.username }</a> </div>
      </div>
...
<%-- 					<a href='http://control.blog.sina.com.cn/admin/article/article_edit.php?blog_id=c36664780102vwf1'class="CP_a_fuc">[<cite>编辑</cite>]</a>
 ...
 --%>		
 				<c:if test="${blog.userid==loginUser.id }">
	 				...
	 				<a class="CP_a_fuc" href="BlogServlet?method=deleteBlog&blogid=${blog.id }">[<cite>删除</cite>]</a>
 				</c:if>
			 ...
			 <c:if test="${empty blog1 }">
		  	...
		  	<c:if test="${!empty blog1 }">
		  		<div>
			  		...
			  		<a href="/blog/BlogServlet?method=getBlogByBlogid&blogid=${blog1.id }">${blog1.title }</a>
			  	</div>
		  	</c:if>
		  	...
		  	<c:if test="${!empty blog2 }">
		  		<div>
				  	...
				  	<a href="/blog/BlogServlet?method=getBlogByBlogid&blogid=${blog2.id }">${blog2.title }</a>
			  	</div>
		    </c:if>
		</div>
		<div class="clearit"></div>
