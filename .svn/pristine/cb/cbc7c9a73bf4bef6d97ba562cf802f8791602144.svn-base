		...
		<div id="bloglink" class="bloglink"><a href="/blog/page/personal/personalCenter.jsp">http://blog.fenbi.com.cn/u/${loginUser.username }</a> </div>
					...
					<div class="blognav" id="blognav">
						...
						<div class="blognavInfo">
							...
							<span><a href="/blog/BlogServlet?method=getBlogtoManage">博文目录</a></span>
							<span><a href="/blog/page/personal/writeBlog.jsp">发文</a></span>
							<span class="last"><a class="on" href="UserServlet?method=toPersonalCenter">个人中心</a></span>
						</div>
					</div>
			...
			<div class="sinablogbody" id="sinablogbody">
				...
				<div id="column_2" class="SG_colW73">
									...
									<tr>
										...
										<td style="text-align: left;">
											<div class="link335bbd textL">
												<a href="BlogServlet?method=getMyBlogByBlogid&blogid=${blog.id }" target="_blank">${blog.title }</a>
											</div>
										</td>
										<td style="text-align: center;">
											<div class="link-ul">
												<p class="a02">${loginUser.username }</p>
											</div>
										</td>
										<td style="text-align: center;"><f:formatDate value="${blog.createTime }" pattern="MM-dd"/></td>
										<td style="text-align: center;"><a href="BlogServlet?method=getBlogtoUpdate&blogid=${blog.id }">修改</a></td>
						...
						<table class="table1" id="table_lit_bang_105">
							...
							<c:forEach items="${commentList }" var="comment">
								<tr>
									...
									<td style="text-align: left;">
										<div class="link335bbd textL">
											<a href="BlogServlet?method=getMyBlogByBlogid&blogid=${comment.blogid }" target="_blank">${comment.blogTitle }</a>
										</div>
									</td>
									<td style="text-align: center;">
										<div class="link-ul">
											<p class="a02">${comment.content }</p>
										</div>
									</td>
									<td style="text-align: center;"><f:formatDate value="${comment.createTime }" pattern="MM-dd"/></td>
									<td style="text-align: center;"><a href="CommentServlet?method=delComment&blogid=${blog.id }&comment_id=${comment.id }">删除</a></td>
								</tr>
							</c:forEach>
						</table>
						</div>
					...
					<div class="sinablogfooter" id="sinablogfooter">
						<p class="SG_linka" style="padding-right: 250px">
						...
						<p class="copyright SG_linka" style="padding-right: 250px">Copyright &copy; 1996 - 2018
