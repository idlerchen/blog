...
<meta name="keywords" content="乔·吉拉德的推销_大龙猫_新浪博客,大龙猫,宠物,顾客,乔·吉拉德,250定律,名片" />
<meta name="description" content="乔·吉拉德的推销_大龙猫_新浪博客,大龙猫," />
<meta http-equiv="mobile-agent" content="format=html5; url=http://blog.sina.cn/dpool/blog/s/blog_c36664780102vwf1.html?vt=4">
<meta http-equiv="mobile-agent" content="format=wml; url=http://blog.sina.cn/dpool/blog/ArtRead.php?nid=c36664780102vwf1&vt=1">
<!–[if lte IE 6]>
...
<link href="css/articleM.css" type="text/css" rel="stylesheet" /><link href="css/common.css" type="text/css" rel="stylesheet" /><link href="css/blog.css" type="text/css" rel="stylesheet" /><link href="css/blog(1).css" type="text/css" rel="stylesheet" /><style id="tplstyle" type="text/css">@charset "utf-8";@import url("css/t.css");
</style>
...
<div class="sinabloga" id="sinabloga">
			 ...
			 <div id="headarea" class="headarea">
			     <div id="blogTitle" class="blogtoparea">
				      <h1 id="blogname" class="blogtitle">
					     <!--   <a href="http://blog.sina.com.cn/ff525448">
					      <span id="blognamespan">加载中...</span></a>-->
				      </h1>
					  		
						<!--  <div id="bloglink" class="bloglink">
						<a href="http://blog.sina.com.cn/ff525448">http://blog.sina.com.cn/ff525448</a>  
						<a onclick="return false;" class="CP_a_fuc" href="#" id="SubscribeNewRss">[<cite>订阅</cite>]</a>
						<a class="CP_a_fuc" href="javascript:void(scope.pa_add.add('3278267512'));">[<cite>手机订阅</cite>]</a>
						</div>-->
			      </div>
			      <div class="blognav" id="blognav">
					  <div id="blognavBg" class="blognavBg"></div> 
					  <div class="blognavInfo">
			  			  <span><a href="first.jsp">首页</a></span>
					      <span><a class="on" href="page/personal/blogManage.jsp">博文目录</a></span>
					      <span class="last"><a  href="page/personal/personalCenter.jsp">个人中心</a></span>
					   </div>
			      </div>      		      		 	
    ...
    <div class="sinablogbody" id="sinablogbody">
	    ...
	    <div class="SG_connBody">
	        <div class="info">           
				<div class="info_img" id="comp_901_head"><img src="http://simg.sinajs.cn/blog7style/images/common/sg_trans.gif" real_src ="#" id="comp_901_head_image" width="180" height="180" alt="${blog.userid}" title="${blog.userid}" /></div>
				   ...
				   <div class="info_txt">
					  ...
					  <div class="info_locate" id = "info_locate_id">
							...
							<div class="info_btn2">
							    <p>
								    <a href="http://blog.sina.com.cn/s/profile_3278267512.html#write" class="SG_aBtn"   id="comp901_btn_msninfo"><cite>写留言</cite></a>
		...
		<!-- 相关博文 <div id="module_903" class="SG_conn ">
		    <div class="SG_connHead">
		    ...
		    <div class="SG_connBody">
			    <div class="atcTitList relaList">        
				    ...
				    <div class="atcTit_more">
				    	<span class="SG_more">
				    		<a href="http://blog.sina.com.cn/" target="_blank">更多&gt;&gt;</a>
				    	</span>
				    </div>
			    </div>
		 	</div>
		...
		<div id="column_2" class="SG_colW73">	
			<div id="module_920" class="SG_conn">
				<div class="SG_connHead">
	    			...
	    			<span class="edit">
	    				<span id="articleFontManage" class="fontSize">字体大小：
	    					<a href="javascript:;" onclick="changeFontSize(2);return false;">大</a> 
	    					<strong>中</strong> 
	    					<a href="javascript:;" onclick="changeFontSize(0);return false;">小</a>
	    				</span>
	    			</span>
				</div>
	    	<div class="SG_connBody">
				...
				<div id="articlebody" class="artical" favMD5='{"c36664780102vwf1":"c064d90c6e3de4008f5c3bf8cda415d7"}'>
					<div class="articalTitle"> 
						<h2 id="t_c36664780102vwf1" class="titName SG_txta">${blog.title }</h2>
						<span class="time SG_txtc"><fmt:formatDate value="${blog.createTime  }" type="date" /></span>
						<div class="turnBoxzz">
							<a href="javascript:;" class="SG_aBtn SG_aBtn_ico SG_turn"  action-type="reblog" action-data="{srcBlog:1, blogId:'c36664780102vwf1'}"><cite><img class="SG_icon SG_icon111" src="http://simg.sinajs.cn/blog7style/images/common/sg_trans.gif" width="15" height="15" align="absmiddle">转载<em class="arrow">▼</em></cite></a>
					...
					<div id="sina_keyword_ad_area2" class="articalContent newfont_family">
						...
						&nbsp;<wbr>第三点，建立顾客档案，分析顾客，了解顾客，长远打算<br />
						&nbsp;<wbr>第四点，s让顾客帮你推销，其实就是第一点，你做得好自然就有顾客会帮你推销出去。<br />
						&nbsp;<wbr>第五点，要有自己的特点，能吸引顾客<br />
						&nbsp;<wbr>第六点，售后的服务，售后才是真正的销售，不是卖了东西就算了。<br />	-->						
					</div>
									<!-- 正文结束 -->
					...
					<div class="articalInfo">
						...
						<!-- <div class="IL">
							...
							<a href="#commonComment">评论</a> 
							<span id="c_c36664780102vwf1" class="SG_txtb"></span><em class="SG_txtb">┊</em>				
							<a href="javascript:;" onclick="$articleManage('c36664780102vwf1',5);return false;">收藏</a>
							<span id="f_c36664780102vwf1"  class="SG_txtb"></span>
							<em class="SG_txtb">┊</em><a href="#" id="quote_set_sign" onclick="return false ;">转载</a>
							<a  href="#" id="z_c36664780102vwf1" onclick="return false ;" class="zznum"></a>				
							<span  class="SG_txtb"></span><em class="SG_txtb">┊</em>
							<a onclick="return false;" href="javascript:;" ><cite id="d1_digg_c36664780102vwf1">喜欢</cite></a>
							<a id="d1_digg_down_c36664780102vwf1" href="javascript:;" ><b>▼</b></a>
							<em class="SG_txtb">┊</em>
							<a href="http://blog.sina.com.cn/main_v5/ria/print.html?blog_id=blog_c36664780102vwf1" target="_blank">打印</a>
							<em class="SG_txtb">┊</em>
							<a id="q_c36664780102vwf1" onclick="report('c36664780102vwf1');return false;" href="#">举报</a>
						</div> -->
						<!--  <div class="IR">
							<table>
								<tr>
			...
			<div class="articalfrontback SG_j_linedot1 clearfix" id="new_nextprev_c36664780102vwf1">
								<div><span class="SG_txtb">前一篇：</span><a href="http://blog.sina.com.cn/s/blog_c36664780102vqi5.html">123</a></div>
									</div>
			<div class="clearit"></div>
			...
			height:158px;width:448px;maring-top:1px;background-color:white;" src="http://blog.sina.com.cn/main_v5/ria/blank2.html"></iframe>
					...
					<div class="formBtn">
						<a href="blog" onclick="return false;" class="SG_aBtn" tabindex="5">
							<cite id="postcommentid">发评论</cite>
						</a>
				...
				<div class="articalfrontback articalfrontback2 clearfix">
						  <div class="SG_floatL"><span class="SG_txtb">&lt;&nbsp;前一篇</span><a href="http://blog.sina.com.cn/s/blog_c36664780102vqi5.html">大汉帝国（一)</a></div>
								</div>
		<div class="clearit"></div>
	...
	<div id="column_3" class="SG_colWnone">
		<div style="width:0px;height:0.1px;margin:0px;">&nbsp;&nbsp;
		</div>
	</div>
	<!--第三列end-->
