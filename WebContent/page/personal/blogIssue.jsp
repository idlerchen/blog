                            ...
                            <div class="SG_connBody">
                                    ...
                                    <div class="blogEditorWrap">
                                        <div class="fWrap" style=" padding-bottom:8px;">
                                        	<input type="hidden" id="blogIdDemo" value="${blog.id }"/>
                                            <ul>
                                        ...
                                        <div class="fWrap">
                                            <ul>
                                                <li class="li1"><span class="cTit">分类：</span>
                                                    <div class="cInfo">
                                                        <select id="componentSelect" data-blogType=${blog.blogType } name="blog_class" class="sel inputWidth" style="height:24px; line-height:24px;">
