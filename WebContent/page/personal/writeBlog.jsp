...
<html>
    <head>
        ...
        <script type="text/javascript" src="/blog/myjs/writeblog.js" ></script>
    </head>
<body>
            <!--sinatopbar-->
  ...
  <div class="ntopbar_main"> 
    ...
    <c:if test="${empty loginUser }">
 	 ...
 	 <c:if test="${!empty loginUser }">
		...
		<a class="register" href="/blog/UserServlet?method=logout">|&nbsp;退出</a>
	</c:if>
	</div>
	</div>
  </div>
...
<!--sinatopbar-->
                ...
                <strong id="SinaBlog_SLOT_40"></strong></span><span class="tip_r" ><strong id="SinaBlog_SLOT_44"></strong>
                            ...
                            <div class="SG_connBody">
                                    ...
                                    <div class="blogEditorWrap">
										...
										<script type="text/javascript" charset="utf-8" src="/blog/utf8-jsp/lang/zh-cn/zh-cn.js"></script>
                                        ...
                                        <div class="fWrap">
                                            <ul>
                                                <li class="li1"><span class="cTit">分类：</span>
                                                    <div class="cInfo">
                                                        <select id="componentSelect" name="blog_class" class="sel inputWidth" style="height:24px; line-height:24px;">
                                                            <option value="00">选择分类</option>
                                                        </select>
                                                        <a href="javascript:void(0);" id="cateManageLink" class="ATextLine" onclick="return false;"></a></div>
                                                </li>
                                               	 <li class="li1"><span class="cTit">我的分类：</span>
                                                    <div class="cInfo">
                                                        <select id="mySort" name="blog_class" class="sel inputWidth" style="height:24px; line-height:24px;">
                                                            <option value="00">选择分类</option>
                                                        </select>
                                                        <input type="button" value="创建分类" onclick="createSort()">
                                                </li>
 ...
 href="http://control.blog.sina.com.cn/blog_rebuild/profile/controllers/bindwemeet.php" target="_blank" class="editorTb"><img width="19" height="19" align="absmiddle" title="同步到微米" src="http://simg.sinajs.cn/blog7style/images/common/sg_trans.gif" class="editls editls03">同步到<span class="cor3">微米</span></a></li>
                                                                            ...
                                                                            <li class="btn">
                                                                                 <a href="javascript:void(0);" id="articleSaveBtn2" class="editBtn1" onclick="return false;"><cite id="articleSaveBtn">发布博文</cite></a>&nbsp;&nbsp;
                                                                                <!-- <a id="articleSaveBtn2" >发布博文</a>&nbsp;&nbsp; -->
